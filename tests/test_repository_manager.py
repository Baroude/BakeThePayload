...
class TestRepositoryManager:
    ...
    @pytest.mark.asyncio
    async def test_clone_public_repository_success(self, repo_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_clone_repository_size_limit_exceeded(self, repo_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_commit_history_with_context(self, repo_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_filter_non_code_files(self, repo_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_after_analysis_pipeline(self, repo_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_checksum_validation(self, repo_manager, temp_dir):
        ...
        is_valid = await repo_manager.validate_repository_integrity(clone_result.local_path)
    ...
    @pytest.mark.asyncio
    async def test_manual_intervention_on_failure(self, repo_manager):
