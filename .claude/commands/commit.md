## Process
0. Run the test with uv run pytest. If tests are failing ask the user before proceeding forward.
...
5. pre-commit hooks are handled automatically
...
- DO NOT TRY TO BYPASS PRE COMMIT HOOKS
